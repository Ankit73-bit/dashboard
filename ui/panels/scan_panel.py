...
SCAN_SERVICES = [
    {
        ...
        "docs": {
            ...
            "when": "Use this as Step 1 after scanning letter/return PDFs. Output renamed_pdfs feed into Barcode Excel Matcher.",
            "steps": [
                ("Select scanned PDFs folder", "Browse to the folder of multi-page scanned PDFs."),
    ...
    },
    {
        ...
        "docs": {
            ...
            "steps": [
                ("Select Excel folder", "Excel files with remark column from Step 2 (Exact Match / Fuzzy Match)."),
...
class ScanPanel(ctk.CTkFrame):
    ...
    def _build(self):
        ...
        ctk.CTkLabel(self,
                     text="SCAN LETTER WORKFLOW  ·  Run steps 1 → 2 → 3 in order",
